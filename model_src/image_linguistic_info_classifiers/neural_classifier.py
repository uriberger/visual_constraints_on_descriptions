...
class InternalClassifier(nn.Module):
    def __init__(self, backbone_model_inference_func, backbone_output_size, output_size, freeze_backbone):
        ...
        self.classification_head = self.get_classification_head(backbone_output_size, output_size)
